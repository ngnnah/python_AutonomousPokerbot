...
class Player(Bot):
    ...
    def allocate_cards(self, my_cards):
        ...
        _MIN_PAIR_VALUE = 5 # TODO: tune, only want pairs stronger than this value
    ...
    def assign_holes(self, hole_cards):
        ...
        if random.random() < .15: # swap best with second
            holes_and_strengths = [board_A, board_C, board_B]
        board_A, board_B, board_C = holes_and_strengths
        if random.random() < .15: # swap second with worst
